...
public interface OrderUserApi {
    ...
    @PatchMapping(value = ORDER_USER_ENDPOINT + "/update/{id}/OrderStatus/{orderStatu}" ,produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<OrderUserDto> updateOrderStatus(@PathVariable Long id, @PathVariable OrderStatu orderStatu);
